...
// Colonne Actions du calendrier des rencontres — même convention que
// ChampionshipRowActions/ExternalTeamRowActions (menu ⋮, masqué entièrement
// si `!canManage`, jamais déduit d'un rôle côté client).
